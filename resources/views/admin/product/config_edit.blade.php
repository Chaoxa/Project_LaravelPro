    ...
    <div class="row">
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::open(['route' => ['product.config.update',$config->id], 'method' => 'post']) }}
                    <div class="form-group">
                        {!! Form::label('name', 'Tên cấu hình') !!}
                        {{ Form::text('name', $config->name, ['class' => 'form-control', 'id' => 'name']) }}
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('storage', $config->memory, ['class' => 'form-control', 'id' => 'storage']) !!}
                        @error('storage')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        {!! Form::text('price', $config->price, ['class' => 'form-control', 'id' => 'price']) !!}
                        @error('price')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            {!! Form::radio('status', '0', $config->status == 0?true:false, ['class' =>
                            'form-check-input', 'id' =>
                            'exampleRadios1']) !!}
                            {!! Form::label('exampleRadios1', 'Chờ duyệt', ['class' => 'form-check-label']) !!}
                        </div>
                        <div class="form-check">
                            {!! Form::radio('status', '1', $config->status == 1?true:false, ['class' =>
                            'form-check-input', 'id' =>
                            'exampleRadios2']) !!}
