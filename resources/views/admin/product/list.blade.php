            ...
            <table class="table table-striped table-checkall">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td><a target="_blank"
                                href="{{url('san-pham'.'/'.$product->slug.'.'.'html')}}"><b>{{Str::limit($product->name,
                                    $limit = 30, $end =
                                    '...')}}</b></></a></td>
                        <td>{{number_format($product->new_price, 0, '.','.').'đ'}}</>
                        </td>
                        <td class="text-center">{{$product->cat_product->name}}</>
                        </td>
                        <td class="text-center"><small><b>{{$product->users->name}}</b></small>
                            <br>
                            <b class="btn-sm btn-primary text-center">{{$product->users->roles[0]['name']}}</b>
                        </td>
