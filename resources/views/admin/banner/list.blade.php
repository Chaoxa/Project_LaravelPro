                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{asset($banner->thumb_banner)}}" class="imgg" data-id="{{ $banner->id }} "
                                data-toggle="modal" data-target="#exampleModalCenter" alt="" width="80px" height="40">
                        </td>
                        <td><a href="" class="link" data-id="{{ $banner->id }}" data-toggle="modal"
                                ...
                                '...')}}</a></td>
                        <td>{{$banner->sort}}</td>
                        <td class="text-center"><small><b>{{$banner->users->name}}</b></small>
                            <br>
                            <b class="btn-sm btn-primary text-center">{{$banner->users->roles[0]['name']}}</b>
                        </td>
