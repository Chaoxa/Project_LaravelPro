...
class ProductController extends Controller
{
    ...
    function product_detail($slug)
    {
        ...
        return view('client.product.detail', compact('product', 'banners', 'thumb_detail', 'render_menu', 'configs', 'categoryProducts'));
    }
    ...
    function product_cat($slug)
    {
        ...
        $products = $this->getProductsByParentId($cat_product->id);
        // return dd($products);
